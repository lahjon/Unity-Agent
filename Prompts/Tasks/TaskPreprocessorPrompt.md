...
- teams_mode (default: false) — Set true ONLY for large multi-step features that need iterative team-based implementation with verification cycles. Most tasks do NOT need this. Only for things like "implement full authentication system" or "build new dashboard page".
...
- iterations (default: 2) — Number of teams mode iterations. Only relevant when teams_mode=true. Use 2-3 for medium features, 4-5 for large ones.
